    ...
    st.markdown(
        ...
        <div class="witt-title-box">
            <div class="witt-header-wrap">
                ...
                <div class="witt-subtitle">A RAG-based Q&A interface for exploring Wittgenstein through his philosophical Nachlass. 
                NB: Conversation mode is not yet implemented.</div>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
